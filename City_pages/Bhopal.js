	...
	return(
		<div id="Bhopal">
			...
			<div id="content_bhopal">
				<CityCard img={Bhopal1} ratings='5' head="Nature Courtyard" text={hotel6.about}location={hotel6.location} price={hotel1.price} paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/><br/>
				<CityCard img={Bhopal2} ratings='2' head="Woods Inn Resort" text={hotel6.about}location={hotel6.location} price={hotel2.price}paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/><br/>
				<CityCard img={Bhopal3} ratings='4.5' head="Madhuban Resort" text={hotel6.about} location={hotel6.location} price={hotel3.price}paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/><br/>
				<CityCard img={Bhopal4} ratings='5' head="Holiday Homes Aand Resort" text={hotel6.about}location={hotel6.location} price={hotel4.price}paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/><br/>
				<CityCard img={Bhopal5} ratings='4' head="Villa De Casa, Bhopal" text={hotel6.about}location={hotel6.location} price={hotel5.price}paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/><br/>
				<CityCard img={Bhopal6} ratings='3.5' head="Laal Kothi,Bhopal" text={hotel6.about}location={hotel6.location} price={hotel6.price}paragraph="asdf sdfg fgh dfg fgdh dfg defr defr edrf derft erdfwt rftgey trgyhr tregryh rtfgy rftgy gteyhr tgyhr gthbry gthbryt gtbhryntju gthyrbt gthyrtuj gtyh gthyrbtju tyhuj ythujt ythuj tyghuj  dfrgte edf fggh ghj fghj gtyrhu hyujiko werty ghnjmk  nm,rrftgyhufvgtbhy gthyrtu"/>
			</div></div>
			<Footer/>
		</div>
	)
